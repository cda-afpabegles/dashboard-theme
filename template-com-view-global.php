...
<div id="content" class="site-content">
  ...
  <input type="radio" name="rag1" class="color0 updated" value="0">
  <input type="radio" name="rag1" class="color1 updated" value="1">
  <input type="radio" name="rag1" class="color2 updated" value="2">
  <input type="radio" name="rag1" class="color3 updated" value="3">
</div> -->
              <?php
                            $args = array( 
                                    'posts_per_page' => -1, 
                                  ...
                                  <tr class="<?php echo $class_valid; ?>" style="border-top:solid 10px darkgrey;">
                                    ...
                                    <td>
                                      ...
                                      <td class="td-validation">
                                        ...
                                        <div class="row">
                                          <p>
                                            <input type="radio" class="input_validation" name="radio-group" value="0"
                                            <?php if( $validation == '0' ) { echo 'checked'; }?>>
                                            <label for="test1">En attente de validation</label>
                                          </p>
                                          <p>
                                            <input type="radio" class="input_validation" name="radio-group" value="1"
                                              <?php if( $validation == '1' ) { echo 'checked'; }?>>
                                            <label for="test2">Action corrective nécessaire (voir commentaire)</label>
                                          </p>
                                          <p>
                                            <input type="radio" class="input_validation" name="radio-group" value="2"
                                              <?php if( $validation == '2' ) { echo 'checked'; }?>>
                                            <label for="test3">Validé</label>
                                          </p>
                                          <p>
                                            <input type="radio" class="input_validation" name="radio-group" value="3"
                                              <?php if( $validation == '3' ) { echo 'checked'; }?>>
                                            <label for="test3">Refusé (voir commentaire)</label>
                                          </p>
                                        </div>
                                      </form>
                                      </td>
