    ...
    <div class="row">
        <div class="col-lg-5 col-12">
            <div class="topbranding mb-3 text-center text-lg-left">
                ...
                <span class="topbranding-title" style="font-size:14px;" ><a href="https://board.afpa.digital/sales/">Voir les prospects</a></span>
            </div>
        </div>
        <div class="col-lg-7 col-12">
            <div class="row text-right">
                <a href="/sales/" class="btn btn-primary ml-3">Voir le tableau de bord</a>
                <a href="/ajout-public/" class="btn btn-primary ml-3">Ajouter un public</a>
                <a href="/ajout-financement/" class="btn btn-primary ml-3">Ajouter un financement</a>
                <a href="/ajouter-un-prospect/" class="btn btn-primary ml-3">Ajouter un prospect</a>
            </div>
        </div>
    </div>
</div>
